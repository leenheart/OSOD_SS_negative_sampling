...
class DatasetsWrapper:
    ...
    def __init__(self, dataset_cfg, skip_train_load, model_classes_names, predictions_path, num_workers, transform=None):
        ...
        if dataset_cfg.name == "coda":
            ...
            self.dataset_test = Coda_dataset(dataset_cfg, dataset_cfg.path_test, dataset_cfg.max_size, self.classes_as_known, self.classes_as_unknown)
            self.dataset_val = Coda_dataset(dataset_cfg, dataset_cfg.path_val, dataset_cfg.max_size, self.classes_as_known, self.classes_as_unknown)
